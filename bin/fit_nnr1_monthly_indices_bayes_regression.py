"""
Fit Bayes regression model to monthly NCEPv1 indices.
"""
...
HADISST_RESULTS_DIR = os.path.join(RESULTS_DIR, 'hadisst')
HADISST_INDICES_DIR = os.path.join(HADISST_RESULTS_DIR, 'indices')

NNR1_RESULTS_DIR = os.path.join(RESULTS_DIR, 'nnr1')
NNR1_INDICES_DIR = os.path.join(NNR1_RESULTS_DIR, 'indices')
...
INDICES_INPUT_FILES = {
    'AO': os.path.join(
        NNR1_INDICES_DIR, 'csv',
        '{}.{}.ao.{}.csv'.format(
            REANALYSIS, BASE_PERIOD_STR, INDICES_FREQUENCY)),
    'DMI': os.path.join(
        HADISST_INDICES_DIR, 'csv',
        'hadisst.{}.dmi.{}.csv'.format(BASE_PERIOD_STR, INDICES_FREQUENCY)),
    'MEI': os.path.join(
        NNR1_INDICES_DIR, 'csv',
        '{}.{}.mei.{}.csv'.format(
            REANALYSIS, BASE_PERIOD_STR, INDICES_FREQUENCY)),
